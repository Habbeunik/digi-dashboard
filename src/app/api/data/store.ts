...
export const recentTransactions: IRecentTransaction[] = [
	...
	},
	{
		user: {
			...
			pic: 'https://api.dicebear.com/8.x/thumbs/svg?seed=1',
		},
		amount: 6500,
	},
	{
		user: {
			...
			pic: 'https://api.dicebear.com/8.x/avataaars-neutral/svg?seed=1',
		},
		amount: 780,
	},
	{
		user: {
			...
			pic: 'https://api.dicebear.com/8.x/big-ears-neutral/svg?seed=1',
		},
		amount: 50,
	},
	{
		user: {
			...
			pic: 'https://api.dicebear.com/8.x/fun-emoji/svg?seed=1',
		},
		amount: 1000,
	},
];
